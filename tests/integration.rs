mod integration {
    ...
    static WITHOUT_ARGS_OUTPUT: &str = "error: the following required arguments were not provided:
  <PATH>
...
";
    ...
    static WITH_FOLDER: &str = "DISK\tBYTES\tPATH
8K\t15B\t./tests/example
";

    static WITH_FOLDER_AND_SLASH: &str = "DISK\tBYTES\tPATH
4K\t3B\ttests/example/0_test.txt
4K\t12B\ttests/example/1_bigger.txt
";

    static WITH_FOLDER_AND_SORTED: &str = "DISK\tBYTES\tPATH
4K\t12B\ttests/example/1_bigger.txt
4K\t3B\ttests/example/0_test.txt
";

    static WITH_FOLDER_AND_TOP: &str = "DISK\tBYTES\tPATH
4K\t12B\ttests/example/1_bigger.txt
";
